...
export default function render(container: HTMLElement) {
  ...
  pic.text(point(240, 63), 'Vout', { textAnchor: 'start', style: { fontSize: 12 } })
  pic.text(point(140, 45), 'R', { style: { fontSize: 12 } })
  pic.text(point(30, 120), 'V', { style: { fontSize: 12 } })
  pic.text(point(238, 120), 'C', { style: { fontSize: 12 } })
