...
export default function render(container: HTMLElement) {
  ...
  pic.edge('A', 'B', { arrowEnd: 'stealth', bendAngle: 35, label: 'bend left', style: { stroke: '#2563eb' } })
  pic.edge('B', 'A', { arrowEnd: 'stealth', bendAngle: 35, style: { stroke: '#94a3b8', dash: 'dashed' } })
  ...
  pic.edge('B', 'C',
    { arrowEnd: 'stealth', out: 315, in: 225, label: { text: 'out 315 / in 225', pos: 0.42, offset: 16 }, style: { stroke: '#7c3aed' } })
  pic.edge('C', 'C', { arrowEnd: 'stealth', loop: 'above', style: { stroke: '#dc2626' } })
