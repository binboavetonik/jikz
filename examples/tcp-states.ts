...
export default function render(container: HTMLElement) {
  ...
  const off = 12
  pic.edge('CLOSED', 'SYN',    { arrowEnd: 'stealth', label: 'send SYN',     bendAngle: 15, labelOffset: -off }, { style: es })
  pic.edge('SYN', 'EST',       { arrowEnd: 'stealth', label: 'SYN+ACK, ACK', bendAngle: 15, labelOffset: -off * 1.8 }, { style: es })
  pic.edge('EST', 'FIN',       { arrowEnd: 'stealth', label: 'close / FIN',  bendAngle: 15, labelOffset: -off }, { style: es })
  pic.edge('FIN', 'CLOSED',    { arrowEnd: 'stealth', label: 'ACK / timeout', bendAngle: 15, labelOffset: -off }, { style: es })
  pic.edge('CLOSED', 'LISTEN', { arrowEnd: 'stealth', label: 'passive open', labelOffset: off },                 { style: es })
