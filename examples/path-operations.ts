...
export default function render(container: HTMLElement) {
  ...
  pic.text(point(60, 24), 'offset ±14', { style: { fontSize: 10 } })
  ...
  pic.text(point(60, 130), 'doublePath', { style: { fontSize: 10 } })
  ...
  pic.text(point(300, 130), 'smoothPath + subPath', { style: { fontSize: 10 } })
